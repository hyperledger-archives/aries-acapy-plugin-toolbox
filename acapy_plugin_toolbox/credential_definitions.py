...
class CredDefRecord(BaseRecord):
    ...
    async def retrieve_by_cred_def_id(
        ...
        return await cls.retrieve_by_tag_filter(context, {"cred_def_id": cred_def_id})
    ...
    async def handle(self, context: RequestContext, responder: BaseResponder):
        ...
        try:
            schema_record = await SchemaRecord.retrieve_by_schema_id(
                context, schema_id=context.message.schema_id
            )
        ...
        await cred_def_record.save(
            context, reason="Committed credential definition to ledger"
        )
    ...
    async def handle(self, context: RequestContext, responder: BaseResponder):
        ...
        try:
            cred_def_record = await CredDefRecord.retrieve_by_cred_def_id(
                context, context.message.cred_def_id
            )
        ...
        try:
            schema_record = await SchemaRecord.retrieve_by_schema_id(context, schema_id)
        except StorageNotFoundError:
        ...
        await cred_def_record.save(context, reason="Retrieved from ledger")
